...
\frame{
  \frametitle{Misure indirette: approccio EFT (Effective Field Theory)}
  \footnotesize
  \begin{itemize}
  ...
  Spesso tuttavia una misura di precisione indica solo un ``scostamento'' che deve poi essere interpretato in qualche modello teorico
  ...
  \begin{center}
    \includegraphics[width=0.6\linewidth]{figs/EFT.png}
  \end{center}
  \item SM EFT ha $\simeq 2000$ operatori possibili, che si riducono
  a $\simeq 100$ con alcune assunzioni su simmetrie e CP. Molti processi fisici sono sensibili a pi\`u di un operatore
  \item EFT Fit deve incorporare molte misure di precisione (EW, top, Higgs)
       per poter individuare discrepanze e, di conseguenza, gli operatori responsabili.
    \end{itemize}
}

\frame{
  \frametitle{Misure indirette: anomaly detection}
  \footnotesize
  \begin{itemize}
